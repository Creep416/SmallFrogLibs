...
/**
 * @brief      Contain array of symbols in buffer, X and Y size, couple of methods for array-editing 
 */
class Screen
{
private:
	//const containing size of symbols in 3d arrray
...
public:
	 ...
	 *
	 * @return     array screen[128][128][8][colarr_size+1] (use get_res() for actual resolution).
	 */
	...
	/**
	 * @brief      Sets the symbol.
	 *
	 * @param[in]  x       x pos of symbol
	 * @param[in]  y       y pos of symbol
	 * @param[in]  z       z layer of symbol
	 * @param[in]  symbol  symbol itself, without colorize-params
	 */
	...
	/**
	 * @brief      clear terminal window from symbols.
	 */
	void clear() //TODO: 
	{
		cout << "\033c";
